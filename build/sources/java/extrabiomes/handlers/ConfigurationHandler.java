...
public abstract class ConfigurationHandler {
    ...
    public static EnhancedConfiguration init(File configFile, boolean upgradeOverride) {
        ...
        try {
            ...
            configuration.addCustomCategoryComment(EnhancedConfiguration.CATEGORY_NEWDAWN,
                    "New Dawn biome size hints.");
            ...
            Property bigTreeSaplingDropRateProperty = configuration.get(Configuration.CATEGORY_GENERAL,
                    "Relative sapling drops", GeneralSettings.bigTreeSaplingDropModifier);
            ...
            Property consoleCommandsDisabled = configuration.get(Configuration.CATEGORY_GENERAL,
                    "DisableConsoleCommands", GeneralSettings.consoleCommandsDisabled);
            ...
            Property useLegacyRedwoods = configuration.get(Configuration.CATEGORY_GENERAL, "UseLegacyRedwoods",
                    autoUpgrade ? true : GeneralSettings.useLegacyRedwoods);
            useLegacyRedwoods.comment = "Set to false to use the new redwood tree generation (default: true = old/legacy generation).";
            GeneralSettings.useLegacyRedwoods = useLegacyRedwoods.getBoolean(true);

            Property useMC18Doors = configuration.get(Configuration.CATEGORY_GENERAL, "UseMC18Doors",
                    GeneralSettings.useMC18Doors);
            ...
            // consoleCommandsDisabled.getBoolean(true);
